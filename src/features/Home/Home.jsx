        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div className="relative">
                <div className="lg:w-2/3">
                    ...
                    <h1 className="mt-6 text-5xl  text-white sm:mt-10 sm:text-5xl lg:text-7xl xl:text-9xl font-bold ">ARTIFICE <br/> STUDIO</h1>
          ...
          <div className="space-y-16">
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              <div className="space-y-6 p-4 rounded-xl bg-white/5 dark:bg-white/5 border border-gray-100 dark:border-gray-900">
                ...
                <h2 className="font-semibold text-xl text-gray-900 dark:text-white">{t("OurVision")}</h2>
                <p>{t("OurVisionText")}</p>
              </div>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="space-y-6 p-4 rounded-xl bg-white/5 dark:bg-white/5 border border-gray-100 dark:border-gray-900">
                ...
                <h2 className="font-semibold text-xl text-gray-900 dark:text-white">{t("OurValue")}</h2>
                <p>{t("OurValueText")}</p>
              </div>
              ...
              <div className="space-y-6 p-4 rounded-xl bg-white/5 dark:bg-white/5 border border-gray-100 dark:border-gray-900">
                ...
                <h2 className="font-semibold text-xl text-gray-900 dark:text-white">{t("OurApproach")}</h2>
